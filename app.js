...
(function () {
  ...
  var T = {
    ar: {
      ...
      disclaimer_1: 'هذا التطبيق مستوحى من كتاب الشيخ محمد الغزالي رحمه الله، وليس بديلاً عن قراءة الكتاب الأصلي. المحتوى ملخصات تعليمية مبسطة وليست نقلاً حرفياً. يُرجى الرجوع للكتاب الأصلي وللعلماء المتخصصين.',
